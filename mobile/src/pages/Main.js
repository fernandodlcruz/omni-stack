...
function Main({ navigation }) {
    ...
    const [currentRegion, setCurrReg] = useState(null);
    ...
    return (
        <>
            ...
            <View style={styles.searchForm}>
                <TextInput style={styles.searchInput} placeholder="Search devs by tech" placeholderTextColor="#999" autoCapitalize="words" autoCorrect={false} value={techs} onChangeText={setTechs} />
